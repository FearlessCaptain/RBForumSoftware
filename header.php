...
<header>
	<div class="nav-login">
		...
		<ul class="navboi">
			...
			<li><a class="nav-button" href="needsmorejpg.php"><i class="fa fa-compress fa-lg"></i> MOAR JPG</a></li>
			...
			<?php
				...
				if (isset($_SESSION['u_id'])) {
					...
					echo '<li><form class="nav-login-form" action="includes/login-inc.php" method="POST">
